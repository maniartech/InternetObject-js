...
const COVERS: Record<string, string[]> = {
  ...
  'the-structure/values/number/number.md': ['tokenizer/numbers', 'tokenizer/numbers-rules', 'parser/values', 'validation/numbers', 'validation/integer-bounds'],
  'the-structure/values/number/bigint.md': ['tokenizer/bigints', 'validation/bigints', 'parser/values'],
  'the-structure/values/number/decimal.md': ['tokenizer/decimals', 'validation/decimals', 'parser/values'],
  ...
  'schema-definition-language/data-types/string/README.md': ['validation/strings', 'validation/strings-constraints'],
