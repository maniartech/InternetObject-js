...
describe('DateTimeDef - DateTime, Date, and Time Types', () => {
  ...
  describe('Multiple datetime fields', () => {
    test('should validate each field independently', () => {
      ...
      expect(() => parseDocument(data, null)).not.toThrow()
    })
