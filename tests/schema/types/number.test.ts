...
describe('NumberDef - Integer and Float Types', () => {
  ...
  describe('uint8 type (0 to 255)', () => {
    test('should accept values within uint8 range', () => {
      expect(() => parseDocument('num: uint8\n---\n0', null)).not.toThrow()
      expect(() => parseDocument('num: uint8\n---\n128', null)).not.toThrow()
  ...
  describe('int16 type (-32768 to 32767)', () => {
    test('should accept values within int16 range', () => {
      expect(() => parseDocument('num: int16\n---\n-32768', null)).not.toThrow()
      expect(() => parseDocument('num: int16\n---\n0', null)).not.toThrow()
  ...
  describe('uint16 type (0 to 65535)', () => {
    test('should accept values within uint16 range', () => {
      expect(() => parseDocument('num: uint16\n---\n0', null)).not.toThrow()
      expect(() => parseDocument('num: uint16\n---\n32768', null)).not.toThrow()
  ...
  describe('int32 type (-2147483648 to 2147483647)', () => {
    test('should accept values within int32 range', () => {
      expect(() => parseDocument('num: int32\n---\n-2147483648', null)).not.toThrow()
      expect(() => parseDocument('num: int32\n---\n0', null)).not.toThrow()
  ...
  describe('uint32 type (0 to 4294967295)', () => {
    test('should accept values within uint32 range', () => {
      expect(() => parseDocument('num: uint32\n---\n0', null)).not.toThrow()
      expect(() => parseDocument('num: uint32\n---\n2147483648', null)).not.toThrow()
  ...
  describe('float and number types', () => {
    test('should accept float values', () => {
      expect(() => parseDocument('num: float\n---\n3.14', null)).not.toThrow()
      expect(() => parseDocument('num: float\n---\n-3.14', null)).not.toThrow()
      expect(() => parseDocument('num: number\n---\n42.5', null)).not.toThrow()
    })
  ...
  describe('Unsupported types', () => {
    test('should throw for int64', () => {
      expect(() => parseDocument('num: int64\n---\n42', null)).toThrow(/not supported/)
    })

    test('should throw for uint64', () => {
      expect(() => parseDocument('num: uint64\n---\n42', null)).toThrow(/not supported/)
    })

    test('should throw for float32', () => {
      expect(() => parseDocument('num: float32\n---\n42', null)).toThrow(/not supported/)
    })

    test('should throw for float64', () => {
      expect(() => parseDocument('num: float64\n---\n42', null)).toThrow(/not supported/)
    })
  })
  ...
  describe('Edge cases', () => {
    test('should handle zero correctly', () => {
      expect(() => parseDocument('num: int\n---\n0', null)).not.toThrow()
      expect(() => parseDocument('num: uint\n---\n0', null)).not.toThrow()
      expect(() => parseDocument('num: { int, min: 0 }\n---\n0', null)).not.toThrow()
    })

    test('should handle boundary values', () => {
      expect(() => parseDocument('num: { int, min: 10, max: 10 }\n---\n10', null)).not.toThrow()
      expect(() => parseDocument('num: { int, min: 10, max: 10 }\n---\n9', null)).toThrow(expect.objectContaining({ errorCode: expect.stringMatching(/^mismatched-(min|max)$|^out-of-range-/) }))
      expect(() => parseDocument('num: { int, min: 10, max: 10 }\n---\n11', null)).toThrow(expect.objectContaining({ errorCode: expect.stringMatching(/^mismatched-(min|max)$|^out-of-range-/) }))
    })
